...
Then I will use a basic process to find the optimal weighting of the stocks using monte carlo simulation which I will then compare against certain benchmarks and pick the best one out of the lot
